...
const HeroSection = () => {
  return (
    <section className='h-[100dvh] md:h-[80dvh] flex flex-col' style={{ 
      ...
      <h1 className='text-2xl md:text-5xl font-extrabold'>Unlimited movies, TV shows, and more</h1>
      <h3 className='md:text-2xl text-xl mt-4'>Watch anywhere. Cancel anytime</h3>
      <h5 className='text-md md:text-lg'>Ready to watch? Enter you email to create or restart your membership.</h5>
      ...
      <div className='flex flex-col lg:flex-row lg:gap-6 w-[90vw] h-[12rem] lg:h-auto mt-8 lg:mt-[8rem] justify-center items-center py-6'
      style={{
      ...
      <div className='flex flex-col justify-center'>
        ...
        <a href="/" className='text-lg text-blue-600 underline'>Learn more</a>
      </div>
      </div>
      </div>
    </section>
